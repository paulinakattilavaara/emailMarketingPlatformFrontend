...
export function LoginPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-green-100">
      ...
      <h1 className="mb-6 text-2xl font-bold text-green-800">Welcome To Our Platform</h1>
        ...
        <form className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="remember" className="text-sm text-green-800">
                Remember me
              </Label>
            </div>
          ...
          <Button className="w-full py-2 mt-4 text-white bg-green-600 rounded-md">Login</Button>
          <Button className="w-full py-2 mt-2 text-green-600 border border-green-600 rounded-md">
            Login with Google
          </Button>
        </form>
      </Card>
